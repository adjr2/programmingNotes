 ...
 */
function clearAll() {
    const memeContent = document.querySelector('.memes-content');
    const funnyContent = document.querySelector('.jokes-content');
    const wisdomContent = document.querySelector('.wisdom-content');
    const riddleContent = document.querySelector('.riddle-content');

    memeContent.innerHTML = '';
    funnyContent.innerHTML = '';
...
function showMeme() {
  ...
  // the following another logic to clear the screen; have created a function clearAll to implement it.
...
function showJoke() {
  ...
  clearAll();
  document.querySelector('.jokes-content').appendChild(newJoke);

//   const memeVar = document.querySelector('button');
//   const imgVar = document.createElement('img');
//   memeVar.setAttribute()
...
function showQuote() {
  ...
  clearAll();
  document.querySelector('.wisdom-content').appendChild(newQuote).appendChild(newAuthor);
}
...
function showRiddle() {
  ...
  clearAll();
  document.querySelector('.riddle-content').appendChild(newQuestion).appendChild(newAnswer);
}
